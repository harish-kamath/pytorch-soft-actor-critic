...
class SAC(object):
    ...
    def save_model(self, env_name, suffix="", actor_path=None, critic_path=None, value_path=None):
        if not os.path.exists('mbrl/models/'):
            os.makedirs('mbrl/models/')

        if actor_path is None:
            actor_path = "mbrl/models/sac_actor_{}_{}".format(env_name, suffix)
        if critic_path is None:
            critic_path = "mbrl/models/sac_critic_{}_{}".format(env_name, suffix)
        if value_path is None:
            value_path = "mbrl/models/sac_value_{}_{}".format(env_name, suffix)
